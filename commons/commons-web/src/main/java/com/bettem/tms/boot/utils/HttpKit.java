...
import com.bettem.tms.boot.xss.WafRequestWrapper;
...
public class HttpKit {
	...
	public static boolean isAcceptHtmlRequest(HttpServletRequest request) {
		String requestAccept = request.getHeader("Accept");
		if (StringUtils.isNotBlank(requestAccept) && requestAccept.contains("text/html")) {
			return true;
		} else {
			return false;
		}
